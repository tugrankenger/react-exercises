  ...
  return (
    <div className='flex items-center justify-center my-4'>
      <div className='w-full max-w-sm bg-white border border-gray-200 rounded-lg flex flex-col items-center shadow-lg'>
        <img className='w-5/6 h-5/6 p-8 rounded-t-lg' src={product.image} alt='' />
        <div className='px-5 pb-5'>
          ...
          <div className="flex items-center justify-between">
            ...
            <NavLink to='#' className='text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus: outline-none
            focus:ring-blue-500 font-medium rounded-lg text-sm py-2.5 px-2.5 text-center'>Add to cart</NavLink>
          </div>
        </div>
      </div>
    </div>
